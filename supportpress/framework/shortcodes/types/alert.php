...
<form action="/" method="get" accept-charset="utf-8">
   ...
   <div class="form-section clearfix">
        <label for="alert-align">Text Alignment</label>
	...
	<a href="javascript:alertDialog.insert(alertDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Place</a>
</form>