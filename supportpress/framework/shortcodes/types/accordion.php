...
<form action="/" method="get" accept-charset="utf-8">
        ...
        <div class="form-section clearfix">
            <label for="accordion-content">Content<br /><small>Leave Blank To Use Highlighted</small></label>
            <textarea type="text" name="accordion-content" value="" id="accordion-content"></textarea>
        </div>
    
    <a href="javascript:AccordionDialog.insert(AccordionDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Place</a>
