		  ...
		  $("#shortcode-select option:selected").each(function () {
			  ...
			  if( shortcodeSelectVal != 'default') {
				$('#selected-shortcode').load('types/'+shortcodeSelectVal+'.php', function(){
			  	...
			  	$('#selected-shortcode').text('Select Type of Shortcode').addClass('padding-bottom');
...
<div id="prth-shortcodes-popup">

	<h2 id="shortcode-selector-title">Shortcodes</h2>
