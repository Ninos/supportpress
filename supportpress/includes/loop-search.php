...
if('portfolio' == get_post_type()) { $img_height = '390';
} elseif('staff' == get_post_type()) { $img_height = '390';
} elseif('whitepages' == get_post_type()) { $img_height = '390';
} elseif('events' == get_post_type()) { $img_height = '390';
