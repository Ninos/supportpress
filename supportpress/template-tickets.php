...
//if ($tickets_status_id == 'Open') { $comparison = 'LIKE'; }

//posts per page
$template_posts_per_page = get_post_meta($post->ID, 'prth_ticket_page_count', true); //get grid style meta
